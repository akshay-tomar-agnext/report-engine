package com.agnext.reporting.configuration.datasource.dg;
...
@EnableJpaRepositories(entityManagerFactoryRef = "reportEntityManagerFactory",
        ...
        basePackages = {"com.agnext.reporting.repository.dg"})
public class chilly {
    ...
    @ConfigurationProperties(prefix = "spring.dg-datasource")
    ...
    public LocalContainerEntityManagerFactoryBean reportEntityManagerFactory(EntityManagerFactoryBuilder builder,
        ...
        return builder
                ...
                .packages("com.agnext.reporting.entity.dg")
                .persistenceUnit("DGScanEntity")
                .build();
    }
